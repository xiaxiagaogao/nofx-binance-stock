...
export const translations = {
  en: {
    ...
    // Fund Manager
    'fundManager.macroThesis': 'Macro Thesis',
    'fundManager.noThesis': 'No macro thesis yet. AI will establish one on the next cycle.',
    'fundManager.stale': 'STALE',
    'fundManager.regime': 'Regime',
    'fundManager.thesis': 'Thesis',
    'fundManager.intent': 'Portfolio Intent',
    'fundManager.sectorBias': 'Sector Bias',
    'fundManager.keyRisks': 'Key Risks',
    'fundManager.portfolioExposure': 'Portfolio Exposure',
    'fundManager.direction': 'Direction',
    'fundManager.netLong': 'Net Long',
    'fundManager.netShort': 'Net Short',
    'fundManager.balanced': 'Balanced',
    'fundManager.coreBeta': 'Core \u03B2',
    'fundManager.tacticalAlpha': 'Tactical \u03B1',
    'fundManager.hedge': 'Hedge',
  ...
  zh: {
    ...
    // Fund Manager
    'fundManager.macroThesis': '宏观论文',
    'fundManager.noThesis': '尚无宏观论文，AI 将在下一个周期建立初始判断。',
    'fundManager.stale': '过期',
    'fundManager.regime': '市场环境',
    'fundManager.thesis': '论文',
    'fundManager.intent': '组合意图',
    'fundManager.sectorBias': '板块偏向',
    'fundManager.keyRisks': '关键风险',
    'fundManager.portfolioExposure': '组合暴露',
    'fundManager.direction': '方向',
    'fundManager.netLong': '净多头',
    'fundManager.netShort': '净空头',
    'fundManager.balanced': '平衡',
    'fundManager.coreBeta': '核心\u03B2',
    'fundManager.tacticalAlpha': '战术\u03B1',
    'fundManager.hedge': '对冲',
